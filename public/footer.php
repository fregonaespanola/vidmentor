    ...
    <div class="container mx-auto px-4">
        <div class="flex flex-wrap justify-between">
            ...
            <div class="w-full md:w-1/3 text-center mb-8 md:mb-0">
                ...
                <ul>
                    <li><a href="#brands" class="hover:underline text-gray-400">Marcas</a></li>
                    <li><a href="#influencers" class="hover:underline text-gray-400">Influencers</a></li>
                    <li><a href="#about" class="hover:underline text-gray-400">Nosotros</a></li>
                    <li><a href="#contact" class="hover:underline text-gray-400">Contacto</a></li>
                </ul>
            </div>
            <div class="w-full md:w-1/3 text-center md:text-right">
                ...
                <div class="flex justify-center md:justify-end space-x-4">
                    ...
                    <a href="#" class="text-gray-400 hover:text-red-500"><i class="fab fa-linkedin-in"></i></a>
                </div>
            </div>
        </div>
